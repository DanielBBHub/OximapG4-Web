...
module.exports = class Logica { 
    ...
    */
    ...
    insertarMedicion(datos) { // Inserta una Medicion en la base de datos
        var textoSQL = 'insert into Medicion values( NULL, $muestra, $tipo, $fecha, $usuario, $latitud, $longitud);' // SQL
        var valoresParaSQL = {$muestra: datos.muestra, $tipo: datos.tipo, $fecha: datos.fecha, $usuario: datos.usuario , $latitud: datos.latitud, $longitud: datos.longitud} // Valores para SQL
